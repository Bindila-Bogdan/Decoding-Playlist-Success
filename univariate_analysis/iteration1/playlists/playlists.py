...
path_playlist_composition = "/user/s3307913/FINAL/PLAYLISTS/COMPOSITION"
...
path_playlist_duration = "/user/s3307913/FINAL/PLAYLISTS/PLAYLISTDURATION"
...
path_word_counts = "/user/s3307913/FINAL/PLAYLISTS/PLAYLISTNAMEWC"
...
path_name_length = "/user/s3307913/FINAL/PLAYLISTS/PLAYLISTNAMELENGTH"
...
path_modification_trends = "/user/s3307913/FINAL/PLAYLISTS/PLAYLISTMODITRENDS"
...
path_follower_stats = "/user/s3307913/FINAL/PLAYLISTS/PLAYLISTFOLLOWERSTATS"
...
path_word_counts = "/user/s3307913/FINAL/PLAYLISTS/PLAYLISTNAMEDESC"
word_counts.write.csv(path_word_counts, header=True, mode='overwrite')

# Analysis 7: Edit Stats
edit_counts_stats = playlists_df.describe("num_edits")

path_edit_counts_stats = "/user/s3307913/FINAL/PLAYLISTS/PLAYLISTEDITS"
...
path_collaborative_counts = "/user/s3307913/FINAL/PLAYLISTS/PLAYLISTTYPE"
